...
Data = load('ExampleStint_FuelCons_Refinement_VAL21T05.mat');

%% RPM ranges definition

RPM_step    = 4000:500:7500;

D.interval    = 50;   % half bandwidth for RPM ranges identification
...
%% map adjust
fun0    = @(x)OLS(x,RPM_step(1:end-1),dmFuel(1,1:end-1));
fun100  = @(x)OLS(x,RPM_step,dmFuel(3,:));
x0      = fminsearch(fun0,[2 0 0]);
x100    = fminsearch(fun100,[9 0 0]);
...
clear fun0 fun100 x0 x100 dmFuel0 dmFuel100
