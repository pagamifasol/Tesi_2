...
for DLFile in DLFiles:
    ...
    fl_LCA_front[N] fl_LCA_rear[N] fl_UCA_Front[N] fl_UCA_Rear[N] fl_TROD_Out[N] fl_PROD[N] \
    fr_LCA_front[N] fr_LCA_rear[N] fr_UCA_Front[N] fr_UCA_Rear[N] fr_TROD_Out[N] fr_PROD[N] \
    rl_LCA_front[N] rl_LCA_rear[N] rl_UCA_Front[N] rl_UCA_Rear[N] rl_TROD_Out[N] rl_PROD[N] \
    rr_LCA_front[N] rr_LCA_rear[N] rr_UCA_Front[N] rr_UCA_Rear[N] rr_TROD_Out[N] rr_PROD[N]'
    ...
    wd = np.vstack((DL['tRun'],DL['sRun'],DL['vCar']*3.6,DL['nEngine']/6.28*60,DL['NGear'],DL['gLong']/9.81,-DL['gLat']/9.81,-DL['gVert']/9.81,-DL['aSteerWheel']*57.325,DL['nYaw']*57.325,
                    ...
                    -DL['xTriBumpStopF']*1000,-DL['xTriBumpStopR']*1000,
                     ...
                     DL['FWishboneLowerFwdFL'], DL['FWishboneLowerRwdFL'],DL['FWishboneUpperFwdFL'],DL['FWishboneUpperRwdFL'],DL['FToeLinkFL'],DL['FPushRodFL'],
                     DL['FWishboneLowerFwdFR'], DL['FWishboneLowerRwdFR'],DL['FWishboneUpperFwdFR'],DL['FWishboneUpperRwdFR'],DL['FToeLinkFR'],DL['FPushRodFR'],
                     DL['FWishboneLowerFwdRL'], DL['FWishboneLowerRwdRL'],DL['FWishboneUpperFwdRL'],DL['FWishboneUpperRwdRL'],DL['FToeLinkRL'],DL['FPushRodRL'],
                     DL['FWishboneLowerFwdRR'], DL['FWishboneLowerRwdRR'],DL['FWishboneUpperFwdRR'],DL['FWishboneUpperRwdRR'],DL['FToeLinkRR'],DL['FPushRodRR']))
