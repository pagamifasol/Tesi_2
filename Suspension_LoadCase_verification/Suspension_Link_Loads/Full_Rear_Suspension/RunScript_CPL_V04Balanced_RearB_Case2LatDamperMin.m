...
% Replace loads (Optional)
    ...
    if (LoadcaseN == 2)
        D.Load(:,37) = 5937 * [0.972826698 0.231045517	-0.015039415]; %Left damper load to rocker
        D.Load(:,38) = 5937 * [0.972826698 -0.231045517	-0.015039415]; %Right damper load to rocker
    end
